...
const SettingIcon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clip-path="url(#clip0_1402_5199)">
        <path
...
const DownloadIcon = () => {
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g clip-path="url(#clip0_1402_25988)">
        <path
          d="M16.6667 24.1667L20 27.5M20 27.5L23.3333 24.1667M20 27.5V20M27.4 25.075C28.1245 24.5655 28.6678 23.8385 28.9511 22.9993C29.2343 22.1601 29.2428 21.2525 28.9753 20.4082C28.7078 19.5639 28.1782 18.8267 27.4634 18.3038C26.7486 17.7809 25.8857 17.4993 25 17.5H23.95C23.6994 16.5232 23.2304 15.616 22.5784 14.8467C21.9265 14.0774 21.1085 13.4661 20.186 13.0586C19.2636 12.6512 18.2607 12.4584 17.2529 12.4946C16.2452 12.5308 15.2588 12.7952 14.368 13.2679C13.4772 13.7405 12.7052 14.409 12.1102 15.2232C11.5151 16.0373 11.1125 16.9759 10.9327 17.9681C10.7529 18.9604 10.8005 19.9805 11.072 20.9517C11.3435 21.9229 11.8317 22.8198 12.5 23.575"
          stroke="#667085"
          stroke-width="1.66667"
          stroke-linecap="round"
          stroke-linejoin="round"
